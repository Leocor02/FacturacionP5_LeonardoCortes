...
namespace FacturacionP5_LeonardoCortes.Formularios
{
    public partial class FrmLogin : Form
    {
        ...
        {
            //TO DO: acá haremos un usuario global que permita evaluar las funciones del sistema 
        ...
        private bool ValidarDatosRequeridos()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("El nombre del usuario no tiene el formato correcto", "Error de validación", MessageBoxButtons.OK);
                    TxtContrasennia.Focus();
